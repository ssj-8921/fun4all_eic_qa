#include "QAG4SimulationEicCalorimeterSum.h"
...
QAG4SimulationEicCalorimeterSum::QAG4SimulationEicCalorimeterSum(
...
int QAG4SimulationEicCalorimeterSum::InitRun(PHCompositeNode *topNode)
{
  _truth_container = findNode::getClass<PHG4TruthInfoContainer>(topNode,
                                                                "G4TruthInfo");
  if (!_truth_container)
  {
    cout << "QAG4SimulationEicCalorimeterSum::InitRun - Fatal Error - "
...
int QAG4SimulationEicCalorimeterSum::Init(PHCompositeNode *topNode)
{
  ...
  //    {
  //      if (Verbosity() >= 1)
  //        cout << "QAG4SimulationEicCalorimeterSum::Init - Process tower occupancies"
  //            << endl;
  //      Init_Tower(topNode);
  //    }
  if (flag(kProcessCluster))
  ...
  {
    if (Verbosity() >= 1)
      cout << "QAG4SimulationEicCalorimeterSum::Init - Process sampling fraction"
           << endl;
...
int QAG4SimulationEicCalorimeterSum::process_event(PHCompositeNode *topNode)
{
  if (Verbosity() > 2)
    cout << "QAG4SimulationEicCalorimeterSum::process_event() entered" << endl;
...
string
QAG4SimulationEicCalorimeterSum::get_histo_prefix()
{
  return "h_QAG4Sim_CalorimeterSum_";
}

PHG4Particle *
QAG4SimulationEicCalorimeterSum::get_truth_particle()
{
  // get last primary
  assert(_truth_container);
...
int QAG4SimulationEicCalorimeterSum::Init_TrackProj(PHCompositeNode *topNode)
{
  Fun4AllHistoManager *hm = QAHistManagerDef::getHistoManager();
  assert(hm);
...
int QAG4SimulationEicCalorimeterSum::process_event_TrackProj(PHCompositeNode *topNode)
{
  if (Verbosity() > 2)
    cout << "QAG4SimulationEicCalorimeterSum::process_event_TrackProj() entered"
         << endl;
...
//int
//QAG4SimulationEicCalorimeterSum::Init_Tower(PHCompositeNode *topNode)
//{
//
//  Fun4AllHistoManager *hm = QAHistManagerDef::getHistoManager();
//  assert(hm);
...
//
//int
//QAG4SimulationEicCalorimeterSum::process_event_Tower(PHCompositeNode *topNode)
//{
//  if (Verbosity() > 2)
//    cout << "QAG4SimulationEicCalorimeterSum::process_event_Tower() entered"
//        << endl;
//
//  return Fun4AllReturnCodes::EVENT_OK;
//}

int QAG4SimulationEicCalorimeterSum::Init_Cluster(PHCompositeNode *topNode)
{
  Fun4AllHistoManager *hm = QAHistManagerDef::getHistoManager();
  assert(hm);
...
int QAG4SimulationEicCalorimeterSum::process_event_Cluster(PHCompositeNode *topNode)
{
  if (Verbosity() > 2)
    cout << "QAG4SimulationEicCalorimeterSum::process_event_Cluster() entered"
         << endl;
  ...
  if (cluster_cemc_e + cluster_hcalin_e + cluster_hcalout_e > 0)
  {
    if (Verbosity())
    {
      cout << "QAG4SimulationEicCalorimeterSum::process_event_Cluster - "
