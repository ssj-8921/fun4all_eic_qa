//[sigma_e vs ge] plots; Eta Cuts; Individual detectors; Standalone; Plots made -//[sigma_e vs ge], [mean_e vs ge], [chi2_e vs ge], slices for the [(ce-ge)/ge vs ge] plot.
